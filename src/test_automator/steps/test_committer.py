...
from test_automator.models import GeneratedTest, PRInfo, TestRunResult
from test_automator.utils.exceptions import TestCommitterError
...
class TestCommitter:
    ...
    def _git_commit(
        ...
        body_lines = [
            f"Auto-generated by test-automator for "
            f"{file_count} file(s).",
        ]
        if test_result:
            body_lines.append("")
    ...
    def _open_pr_via_gh(self, pr_info: PRInfo) -> str | None:
        ...
        body = (
            "Tests generated locally by test-automator.\n\n"
